...
Images are pre-encoded as WebP at quality 85: portraits up to 900 px wide, products up to 1000 px, decorations up to 640 px (the small shop dog is 320 px). The hero poster uses AVIF quality 50 at 2560 px. Explicit `?url` imports preserve these delivery bytes. Below-the-fold images use native lazy loading.
